...
We developed a linear model that characterizes the number of rides per station as a surrogate for utilization of Citi Bikes. Predictors included median air quality, median social deprivation index, and percentage of overweight individuals in a neighborhood. We then iterated on these models.
