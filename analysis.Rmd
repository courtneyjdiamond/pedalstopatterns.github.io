...
**TO DO ridership by days of the week:**
...
Subscribers make up the large majority of rides.Males take the most rides! And 30 year olds and 50 year olds use citibike the most!
...
stations_SDI |>
  ggplot(aes(x = SDI, y = count, color = status)) + geom_point() +
  facet_grid(~status)
...
stations_overweight |>
  ggplot(aes(x = Overweight_pct, y = count, color = status)) + geom_point() +
  facet_grid(~status)
