 ...
 * First, we need to convert the Citibike location data from latitude/longitude to zip code.
    * This was done using a package [tidygeocoder](https://jessecambon.github.io/tidygeocoder/). Here, we import the latitude/longitude to zipcode crosswalk we generated. The full code with details of how that was created [can be found here](latlong_to_zip.html). 
