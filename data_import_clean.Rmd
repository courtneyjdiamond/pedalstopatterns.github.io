...
# Stations Analysis 
For some extra analysis work, we want to understand the full avaialbility of stations, not just the ones used in September, So we also have to join zipcode and UHF34 neighborhood to our full station data.
```{r station_uhf}
stations = stations |>
  left_join(latlong_zip, 
