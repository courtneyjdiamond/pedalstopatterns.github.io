...
# Join Zipcode onto Citibike data 
Load latitude/longitude to zip code crosswalk to merge start_zip and end_zip onto citibike_df 
...
citibike_zip |>
  select(start_zipcode, start_station_longitude, start_station_latitude,
         end_zipcode, end_station_longitude, end_station_longitude) |>
  head()
