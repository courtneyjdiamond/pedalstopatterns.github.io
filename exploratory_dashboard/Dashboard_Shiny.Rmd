...
sankey_plot_man |> 
  layout(
    title = "Citibike Trips Completed in Manhattan",
    font = list(size = 10))  
...
sankey_plot_bklyn |> 
  layout(
    title = "Citibike Trips Completed in Brooklyn",
    font = list(size = 10))
}
...
sankey_plot_qns |> 
  layout(
    title = "Citibike Trips Completed in Queens",
    font = list(size = 10))
...
sankey_plot_bx |> 
  layout(
    title = "Citibike Trips Completed in the Bronx",
    font = list(size = 10))
}
